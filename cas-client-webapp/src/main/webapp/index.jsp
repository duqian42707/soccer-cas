...
<hr>
<a href="http://localhost:8081/">客户端1</a>
<a href="http://localhost:8082/">客户端2</a>


<p><b>Authenticated User Id:<%= request.getRemoteUser() %></b> <a href="logout.jsp" title="Click here to log out">logout</a></p>
